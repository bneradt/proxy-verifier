...
public:
  ...
  /// Create a QUIC connection to the given IP address.
  swoc::Errata do_connect(swoc::IPEndpoint const *target) override;
...
private:
  ...
  swoc::Errata connect_udp_socket(swoc::IPEndpoint const *target);
